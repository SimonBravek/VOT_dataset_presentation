// This creates the video name list that sends u to the right video after clicking and the downloading in the side

import { videoNameList } from './01_inputUpdateNeeded.js';
...
for (const item of videoNameList) {
  ...
  anchorElement2.setAttribute("href", "Media/" + item + "/" + item + ".mp4"); // HIGHLIGHT: there is a part of the folder structure
